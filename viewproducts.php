...
<form action="" method="POST" >	
		<div class="container">
			<div class="row">
                           ...
                           //  while($rows = mysqli_fetch_array($query)){
							//   echo "<pre>"; print_r($rows); echo "</pre>"; 
								...
								<div class="panel-heading">
									...
									<h4 class="panel-title"><a href="viewproducts.php?id=<?php echo $rows['id']; ?>">
               ...
               <button class="btn btn-large bt"><a href="index.php">Back</a></button>
                     
						<h2 class="title text-center" style="color:black">Featuring Products</h2>
                  <br>
                        <?php
						if(isset($_GET['id'])){
							$id = $_GET['id'];
						    $query12 = mysqli_query($conn, "SELECT * FROM products WHERE category=$id");
						//    var_dump($query2);
                        ...
                        <?php } ?>
						<?php  } else {
							$query3 = mysqli_query($conn, "SELECT * FROM products WHERE category=$id");
